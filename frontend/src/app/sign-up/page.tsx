...
export default function SignUpPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (email && password) {
      console.log('Sign up requested with:', { email, password, acceptMarketing, savePassword });
        ...
        <div className="w-full max-w-[416px] mx-auto flex flex-col justify-between h-full">
              ...
              <div className="flex flex-col gap-8">
                <div className="flex flex-col gap-4">
                  ...
                  <p className="text-base text-[#4E5562] leading-6">
                    Join Cartzilla to enjoy all the benefits of our platform.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                  ...
                  <div className="relative group">
                    ...
                    />
                    <p className="mt-2 text-xs text-[#9CA3AF]">Passwords must be at least 8 characters.</p>
                  </div>
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-3">
                      ...
                      />
                      <label htmlFor="savePassword" className="text-sm text-[#4E5562]">
                        Save the password
                      </label>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      <input
                        ...
                        className="w-5 h-5 mt-1 text-[#F55266] bg-white border-[#CAD0D9] rounded focus:ring-[#F55266]/20"
                      />
                      <label htmlFor="acceptMarketing" className="text-sm text-[#4E5562]">
                        I would like to receive personalized commercial offers from Cartzilla by email.
                      </label>
                    </div>
                  </div>
                ...
                <div className="text-center">
                  <p className="text-sm text-[#4E5562]">
                    ...
                    <Link href="/signin" className="font-medium text-[#181D25] underline hover:text-[#F55266] transition-colors duration-300">
                      Sign in
                    </Link>
                  </p>
                </div>
          ...
          <footer className="text-center text-[#4E5562] py-4">
            <div className="flex items-center justify-center gap-2 text-sm">
              <span>Need help?</span>
              <Link href="/contact" className="font-medium text-[#222934] underline underline-offset-4 hover:text-[#F55266] transition-all duration-300 hover:underline-offset-2">
                Contact us
              </Link>
            </div>
